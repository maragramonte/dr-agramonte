...
INSERT INTO centros (codigo, nombre, direccion, ciudad) VALUES
...
ALTER TABLE citas ADD COLUMN IF NOT EXISTS centro_id BIGINT
    REFERENCES centros(id) ON DELETE SET NULL;

CREATE INDEX IF NOT EXISTS idx_citas_centro ON citas(centro_id);
