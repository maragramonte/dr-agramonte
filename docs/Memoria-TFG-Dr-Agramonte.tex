...
\textbf{Reflexión:} la coherencia entre memoria, código y demo oral es tan importante como la funcionalidad; este documento describe la versión real del sistema, no una versión idealizada.
