...
Estos siete objetivos se retoman en el capítulo de conclusiones para comprobar, uno a uno, su grado de cumplimiento.
...
\textbf{Cumplimiento de los objetivos.} Retomando los siete objetivos específicos planteados al inicio, el balance es el siguiente:
...
\begin{itemize}
  ...
  \item \textbf{Seguridad y escalado:} \emph{refresh token}, despliegue en la nube con HTTPS y réplicas de base de datos.
  \item \textbf{Historial clínico:} API y panel clínico reales, con almacenamiento flexible por especialidad.
\end{itemize}
