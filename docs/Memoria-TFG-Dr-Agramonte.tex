...
\begin{itemize}
  ...
  \item \textbf{Flyway.} Versiona el esquema en migraciones numeradas (V1 a V7), de modo que cualquier entorno —el de desarrollo, el del tribunal o uno futuro en producción— se reconstruye exactamente igual al arrancar.
...
\begin{enumerate}
  \item \emph{Modelo de datos en PostgreSQL con Flyway.} \textbf{Cumplido:} seis tablas, migraciones V1--V7 y perfiles \texttt{postgres}/\texttt{mysql}.
