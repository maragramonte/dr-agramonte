...
\vspace{0.5em}
\noindent\textbf{Palabras clave:} citas médicas, aplicación web, Spring Boot, API REST, PostgreSQL, JWT, concurrencia, Twilio, Docker, despliegue en la nube, HTTPS, PWA, accesibilidad.
