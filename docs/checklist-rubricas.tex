...
Avisos por Twilio / Telegram (opcional) & $\square$ & $\square$ & \\
\midrule
...
Bot de Telegram (vinculación + webhook) & $\checkmark$ & $\checkmark$ & Requiere \texttt{.env} \\
Panel médico API historial & $\square$ & $\square$ & Solo demo estática \\
47 tests JUnit + Testcontainers & $\checkmark$ & $\checkmark$ & E2E (Playwright) pendiente \\
